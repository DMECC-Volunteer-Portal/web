...
class ProfileProgress extends Component {
    profileToolTip() {
        if (this.props.user.filled_entries < 17) {
            return (
                <div className="col-start-2 row-start-5 sm:row-start-1 md:row-start-5 xl:row-start-1">
    ...
    render() {
        ...
        return (
            <Fragment>
                ...
                <div className="row-start-6 col-span-full grid w-full h-[2vw] md:h-[1vw] border-normal self-end">
